    ...
    <div className="w-full">
      <div className="w-screen h-[30vh] lg:h-[40vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10">
          <h2 className="mb-2">Level Fitness</h2>
          <h3>HTML | SCSS | Javascript | jQuery</h3>
        </div>
      </div>
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <p>
            This Website was built by using HTML, SCSS, Javascipt and small code
            of jQuery. I used interactives elements, such as smoth-scroll to
            anchors, scroll to top, animations by scroll, burger menu, Swiper
            slider, validation of Forms, Load more.
          </p>
