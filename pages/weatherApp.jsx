    ...
    <div className="w-full">
      <div className="w-screen h-[30vh] lg:h-[40vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10">
          <h2 className="mb-2">Weather App</h2>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <p>
            ...
            receive actual information about weather in their region. This is
            made possible with OpenWeather API.
          </p>
          <a data-set="goto-progect"
            href="https://natalyabortsova.github.io/weather-react-app/"
            target="_blank"
            rel="noreferrer"
          ...
          <a data-set="goto-progect"
            href="https://github.com/NatalyaBortsova/weather-react-app"
            target="_blank"
            rel="noreferrer"
